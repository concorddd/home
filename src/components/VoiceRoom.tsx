...
export function VoiceRoom({
  ...
  if (connecting) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-[#313338] text-[#dbdee1]">
        ...
        <p className="text-sm text-[#949ba4] mt-1">{channelName}</p>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center h-full bg-[#313338] text-[#dbdee1] p-6">
    ...
    <div className="flex flex-col h-full bg-[#313338] text-[#dbdee1]">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#1e1f22]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[#949ba4] ml-2">{formatClock(callSeconds)}</span>
        </div>
        ...
        >
          ...
          >
            ...
            <div className="absolute bottom-2 left-2 flex items-center gap-1 bg-black/60 rounded px-2 py-1">
              ...
              <span className="text-[10px] text-[#949ba4]">Você</span>
            </div>
            {!micOn && (
