-- ============================================================
-- Garante que todos os buckets de storage existam
-- ============================================================
...
-- Bucket para banners (já criado em outra migração, mas garante aqui também)
INSERT INTO storage.buckets (id, name, public)
VALUES ('banners', 'banners', true)
ON CONFLICT (id) DO NOTHING;

-- Bucket para áudio (já criado em outra migração, mas garante aqui também)
INSERT INTO storage.buckets (id, name, public)
